...
<form id="form-create-construccion" data-prevent-loss="true" class="needs-validation" action="{{route('construcciones.update', $construccion->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 text-center">
              ...
              <div class="d-flex flex-wrap justify-content-center gap-2">
                <div class="custom-control custom-checkbox mr-3">
                  <input class="custom-control-input @error('acceso_publico') is-invalid @enderror" type="checkbox" id="acceso_publico" name="acceso_publico" value="1" {{ old('acceso_publico', $construccion->acceso_publico) ? 'checked' : '' }}>
                  <label for="acceso_publico" class="custom-control-label">Acceso público</label>
                </div>
                <div class="custom-control custom-checkbox mr-3">
                  <input class="custom-control-input @error('acceso_temporal') is-invalid @enderror" type="checkbox" id="acceso_temporal" name="acceso_temporal" value="1" {{ old('acceso_temporal', $construccion->acceso_temporal) ? 'checked' : '' }}>
                  <label for="acceso_temporal" class="custom-control-label">Acceso temporal</label>
                </div>
                <div class="custom-control custom-checkbox mr-3">
                  <input class="custom-control-input @error('tecnologia_perdida') is-invalid @enderror" type="checkbox" id="tecnologia_perdida" name="tecnologia_perdida" value="1" {{ old('tecnologia_perdida', $construccion->tecnologia_perdida) ? 'checked' : '' }}>
            ...
            <div class="row mb-3">
              <div class="col-md-4">
                <div class="custom-control custom-switch mt-2">
                  <input type="checkbox" class="custom-control-input @error('tiene_magia_inherente') is-invalid @enderror" id="tiene_magia_inherente" name="tiene_magia_inherente" value="1" {{ old('tiene_magia_inherente', $construccion->tiene_magia_inherente) ? 'checked' : '' }}>
    ...
    <x-reference-images-manager :imagenes="$construccion->imagenes" entityType="construcciones" :entityId="$construccion->id" />
  </form>
