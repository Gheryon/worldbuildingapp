            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <select class="form-select form-control @error('tipo_organizacion_id') is-invalid @enderror" name="tipo_organizacion_id" id="tipo_organizacion_id" @if($tipo_organizacion->count()>0)required @endif>
                  ...
                  <option value="{{$tipo->id}}" {{ old('tipo_organizacion_id', $organizacion->tipo_organizacion_id) == $tipo->id ? 'selected' : '' }}>{{$tipo->nombre}}</option>
                  @endforeach
                  @endif
                </select>
              ...
              <div class="col-md">
                ...
                <select class="form-select form-control @error('lider_id') is-invalid @enderror" name="lider_id" id="lider_id">
                  ...
                  <option value="{{$id}}" {{ old('lider_id', $organizacion->lider_id) == $id ? 'selected' : '' }}>{{$nombre}}</option>
                  @endforeach
                </select>
                @error('lider_id')
                <small style="color: red">{{$message}}</small>
              ...
              <div class="col-md">
                ...
                <select class="form-select form-control @error('organizacion_padre_id') is-invalid @enderror" name="organizacion_padre_id" id="organizacion_padre_id">
                  ...
                  <option value="{{$id}}" {{ old('organizacion_padre_id', $organizacion->organizacion_padre_id) == $id ? 'selected' : '' }}>{{$nombre}}</option>
                  @endforeach
                </select>
