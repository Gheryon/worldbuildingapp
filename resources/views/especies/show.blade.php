...
<li class="nav-item ml-2">
  <a href="{{route('especies.edit', $especie->id)}}" class="btn btn-dark ml-2">Editar</a>
</li>
@endsection
  ...
  <div class="container">
    <div class="row mb-4">
      <div class="col-12 text-center text-md-left border-bottom-dark pb-3">
        <h1 class="display-4 font-weight-bold mb-1 text-primary-custom">{{ $especie->nombre }}</h1>
        <p class="lead text-secondary-custom font-italic">{{ $especie->reino }} / {{ $especie->clase_taxonomica }}</p>
      </div>
    </div>
