...
<section class="content">
  <form id="form-edit-conflicto" data-prevent-loss="true" class="needs-validation" action="{{route('conflictos.update', $conflicto->id )}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
              ...
              <div class="col-md-12">
                ...
                <div class="d-flex gap-4 align-items-center">
                  <div class="custom-control custom-radio mr-4">
                    <input class="custom-control-input @error('bando_vencedor') is-invalid @enderror" type="radio" id="vencedor_atacante" name="bando_vencedor" value="atacante"
                  ...
                  <div class="custom-control custom-radio mr-4">
                    <input class="custom-control-input @error('bando_vencedor') is-invalid @enderror" type="radio" id="vencedor_defensor" name="bando_vencedor" value="defensor"
                  ...
                  <div class="custom-control custom-radio">
                    <input class="custom-control-input @error('bando_vencedor') is-invalid @enderror" type="radio" id="vencedor_ninguno" name="bando_vencedor" value="ninguno"
