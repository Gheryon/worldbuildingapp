  ...
  <form id="form-create-conflicto" data-prevent-loss="true" class="needs-validation" action="{{route('conflictos.store')}}" method="post">
    ...
    <div class="card card-outline card-dark shadow-sm">
      ...
      <div class="card-body bg-light">
        <div class="row">
          <div class="col-md-7">
            <div class="row">
              <div class="col-md-12 mb-3">
                <x-text-input name="nombre" label="Nombre del conflicto" placeholder="Ej: Guerra de las Tres Coronas" :value="old('nombre')" icon="fa-swords" required />
              </div>
            </div>
            <div class="row">
          ...
          <div class="col-md-5 border-left">
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                <x-text-input name="tipo_localizacion" label="Tipo de localización" placeholder="Ej: terrestre, aéreo, mixto, etc..." :value="old('tipo_localizacion')" icon="fa-map-marked-alt" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <x-date-input-group name="fecha_inicio" label="Fecha de inicio" :dia="old('dia_fecha_inicio')" :mes="old('mes_fecha_inicio')" :anno="old('anno_fecha_inicio')" icon="fa-calendar-plus" />
          </div>
          <div class="col-md-6">
            <x-date-input-group name="fecha_fin" label="Fecha de conclusión" :dia="old('dia_fecha_fin')" :mes="old('mes_fecha_fin')" :anno="old('anno_fecha_fin')" icon="fa-calendar-times" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body bg-white">
        <div class="tab-content">
          ...
          <div class="tab-pane fade show active" id="tab-relato">
            <x-textarea-input name="descripcion" label="Descripción general" :value="old('descripcion')" icon="fa-align-left" />
            <x-textarea-input name="preludio" label="Preludio y causas" :value="old('preludio')" icon="fa-history" />
            <x-textarea-input name="desarrollo" label="Desarrollo del conflicto" class="summernote" :value="old('desarrollo')" icon="fa-scroll" />
          </div>

          {{-- Pestaña bélica --}}
          <div class="tab-pane fade" id="tab-belico">
            <div class="row">
              <div class="col-md-6"><x-textarea-input name="unidades_especiales" label="Unidades militares especiales" :value="old('unidades_especiales')" icon="fa-shield-alt" /></div>
              <div class="col-md-6"><x-textarea-input name="criaturas_combate" label="Criaturas de combate" :value="old('criaturas_combate')" icon="fa-paw" /></div>
              <div class="col-md-12"><x-textarea-input name="maquinaria_warlike" label="Maquinaria de guerra" :value="old('maquinaria_warlike')" icon="fa-hammer" /></div>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="tab-magia">
            ...
            <div class="row">
              <div class="col-md-6"><x-textarea-input name="hechizos_decisivos" label="Hechizos decisivos" :value="old('hechizos_decisivos')" icon="fa-magic" /></div>
              <div class="col-md-6"><x-textarea-input name="armas_magicas_empleadas" label="Artefactos y armas mágicas" :value="old('armas_magicas_empleadas')" icon="fa-magic" /></div>
              <div class="col-md-6"><x-textarea-input name="seres_sobrenaturales_participantes" label="Seres sobrenaturales" :value="old('seres_sobrenaturales_participantes')" icon="fa-ghost" /></div>
              <div class="col-md-6"><x-textarea-input name="fenomenos_naturales" label="Fenómenos extraños/naturales" :value="old('fenomenos_naturales')" icon="fa-bolt" /></div>
            </div>
          </div>
