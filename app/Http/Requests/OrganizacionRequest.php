...
class OrganizacionRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      // Selects
      'tipo_organizacion_id' => 'required|exists:tipo_organizacion,id',
      'lider_id' => 'nullable|exists:personajes,id',
      'religiones' => 'nullable|array',
      'religiones.*' => 'exists:religiones,id',
      'organizacion_padre_id' => 'nullable|exists:organizaciones,id',
  ...
  public function messages()
  {
    return [
      ...
      'tipo_organizacion_id.required' => 'Debe seleccionarse un tipo de organización.',
      'tipo_organizacion_id.exists' => 'El tipo de organización seleccionado no existe.',
      'lider_id.exists' => 'El líder seleccionado no existe en el sistema.',
      'religiones.*.exists' => 'Una o más religiones seleccionadas no existen.',
      'organizacion_padre_id.exists' => 'La organización padre seleccionada no existe.',
